...
| Restore | **I10-C – Preflight + Content-Lock + no-clobber + atomarer Batch-Restore implementiert** |
...
- **I10-C** – validate-before-mutate Restore mit Content-Lock-Prüfung, no-clobber und atomarem I08-Batch-Rollback bei Abort.
...
- I10-C schreibt ausschließlich nach vollständig grünem Preflight und genau einmal atomar in den I08 Event Store; I11-Hashketten, Crypto, produktive Contentpakete und echte Spiellogik werden weiterhin nicht vorgezogen.

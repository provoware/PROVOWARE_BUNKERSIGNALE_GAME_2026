...
## I10 Exit
I10 ist nur grün, wenn Storage Health gültige Browser-Estimates an den exakten 75-%-/90-%-Grenzen klassifiziert und fehlende oder fehlerhafte Storage-APIs fail-soft als unbekannt behandelt. Persistenzstatus bleibt von der Kapazitätsampel getrennt. Der Backup-v1-Vertrag darf ausschließlich autoritative Welt-Events plus notwendige Kompatibilitätsmetadaten enthalten; I09-Snapshots bleiben ausgeschlossen. Restore muss Backup, Content-Basis und freie Zielwelt vollständig vor jedem Write prüfen, no-clobber arbeiten und bei Abort null partielle Events hinterlassen. Export -> Restore -> Replay muss denselben Zustand liefern; das 1000-Event-Profil, Repository Quality, allgemeiner Chromium-Smoke und I10 Game UI Regression Shell müssen grün bleiben. G1/G4/G6/G7/G8 sind verbindlich; I11+-Funktionen bleiben außerhalb von I10.
